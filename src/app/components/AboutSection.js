          ...
          <div className="flex flex-col md:flex-row items-center gap-5 sm:gap-8">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
              ...
              <p className="mt-2 sm:mt-4 text-xs sm:text-base md:text-lg text-gray-600 text-center md:text-left leading-relaxed">
                I am a passionate math tutor with over 5 years of experience in home tutoring and academy classes, dedicated to helping students excel in mathematics and statistics. I hold a BS in Mathematics and Statistics and an MPhil in Mathematics from GC University, Faisalabad. My teaching philosophy focuses on building a strong foundation in mathematical concepts while fostering a deep love for learning. With a structured yet engaging approach, I strive to make math and statistics accessible and enjoyable for students of all levels.
              </p>
