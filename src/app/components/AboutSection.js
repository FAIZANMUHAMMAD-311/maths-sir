export default function AboutSection() {
  return (
    <section
      id="about"
      className="min-h-screen flex items-center justify-center bg-gray-50 px-3 sm:px-4 py-6 sm:py-8 lg:py-16 select-none"
    >
        ...
        <div className="flex flex-col md:flex-row items-center gap-5 sm:gap-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center" data-aos="fade-up" data-aos-duration="1000">
            <img
              src="/images/Me.jpg"
              alt="Ibrar Tahir"
              className="rounded-lg shadow-xl w-28 sm:w-40 md:w-48 lg:w-56 xl:w-64 object-cover border-4 border-white"
              draggable="false"
            />
            <div className="mt-3 sm:mt-6 bg-white bg-opacity-90 shadow-lg rounded-lg p-3 sm:p-6 w-40 sm:w-56 md:w-64 text-center">
              <p className="text-xs sm:text-base font-semibold text-blue-600">
                Name: <span className="font-normal text-gray-700">Ibrar Tahir</span>
              </p>
              <p className="mt-2 text-xs sm:text-base font-semibold text-blue-600">
                Experience: <span className="font-normal text-gray-700">5+ Years</span>
              </p>
            </div>
          </div>
