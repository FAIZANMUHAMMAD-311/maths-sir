...
export default function CoursesSection() {
  ...
  return (
    <div className="relative w-full min-h-screen overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="mt-3 text-sm sm:text-base md:text-lg text-gray-700 max-w-xl mx-auto">
                Explore my tailored courses designed to help you excel in math,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 pb-6">
              {[
                {
                  title: "Matriculation Part 1",
                  subjects: "Math & Physics",
                  class: "Class 9",
                  delay: 100,
                },
                {
                  title: "Matriculation Part 2",
                  subjects: "Math & Physics",
                  class: "Class 10",
                  delay: 200,
                },
      ...
      <button
        onClick={toggleSwipe}
        className="fixed top-1/2 right-4 z-10 bg-blue-600 text-white p-3 rounded-full shadow-lg hover:bg-blue-700 transition-transform duration-300 w-12 h-12 flex items-center justify-center text-2xl font-bold"
        style={{
