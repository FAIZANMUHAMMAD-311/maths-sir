    ...
    >
      <div className="text-center max-w-3xl">
        ...
        >
          ...
          and entrance exam math prep. Build a strong foundation with structured, 
          engaging lessons tailored to your needs.
        </p>
        <div
      ...
      <a
        ...
        className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 bg-red-600 text-white px-4 py-3 rounded-full flex items-center shadow-lg transition-transform duration-300 hover:scale-110 z-30"
      >
        <img
      ...
      <a
        ...
        className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 bg-green-500 text-white px-4 py-3 rounded-full flex items-center shadow-lg transition-transform duration-300 hover:scale-110 animate-pulse z-30"
      >
        <img
