    ...
    >
      <div className="text-center max-w-3xl w-full px-4">
        ...
        >
          <a
            href="#hire"
            className="bg-white text-blue-600 px-5 sm:px-8 py-2 sm:py-3 rounded-full text-base sm:text-lg font-semibold hover:bg-gray-100 transition duration-300"
          >
            Hire Me
          </a>
          <a
            href="#access"
            className="bg-transparent border border-white px-5 sm:px-8 py-2 sm:py-3 rounded-full text-base sm:text-lg font-semibold hover:bg-white hover:text-blue-600 transition duration-300"
          >
            Get Access
          </a>
        </div>
      ...
      <a
        ...
        className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 bg-red-600 text-white px-3 py-2 sm:px-4 sm:py-3 rounded-full flex items-center shadow-lg transition-all duration-300 hover:scale-110 z-30"
      >
        <img
          src="https://upload.wikimedia.org/wikipedia/commons/4/42/YouTube_icon_%282013-2017%29.png"
          alt="YouTube Logo"
          className="w-4 sm:w-5 h-4 sm:h-5 md:w-6 md:h-6 block"
        />
        <span className="ml-2 text-xs sm:text-sm md:text-base font-semibold hidden sm:inline">
          YouTube
        </span>
      </a>
      ...
      <a
        ...
        className="absolute bottom-4 right-4 sm:bottom-6 sm:right-6 bg-green-500 text-white px-3 py-2 sm:px-4 sm:py-3 rounded-full flex items-center shadow-lg transition-all duration-300 hover:scale-110 animate-pulse z-30"
      >
        <img
